...
public class Nothing extends Addable {
	...
	public Nothing() {
		int[] temp = { Material.FERN, Material.GRASS, Material.DANDELION, Material.POPPY, Material.BROWN_MUSHROOM,
				Material.RED_MUSHROOM, Material.REDSTONE_DUST, Material.WHEAT, Material.OAK_DOOR, Material.LADDER,
				Material.RAIL, Material.OAK_WALL_SIGN, Material.LEVER, Material.STONE_PRESSURE_PLATE,
				Material.IRON_DOOR, Material.OAK_PRESSURE_PLATE, Material.SUGAR_CANE, Material.SUNFLOWER,
				Material.COBWEB, Material.DETECTOR_RAIL, Material.DETECTOR_RAIL, Material.FIRE,
