...
public class ResultPanel extends JPanel {
	...
	private Runnable uponShowFile = RunnableEmpty.INSTANCE;
	private Runnable uponShowFileIntern = () -> this.uponShowFile.run();
	private JLabel lbl_Texturesfound;
	private Runnable updateTextures = RunnableEmpty.INSTANCE;
	private Runnable updateTexturesIntern = () -> this.updateTextures.run();
	private Runnable openHammerEditor = RunnableEmpty.INSTANCE;
...
//	}
	...
	private void initialize() {
		...
		springLayout.putConstraint(SpringLayout.EAST, lblSuccessfullyConvertedTo, -10, SpringLayout.EAST, this.panel_Result);
		...
		springLayout.putConstraint(SpringLayout.NORTH, lblSuccessfullyConvertedTo, 10, SpringLayout.NORTH, this.panel_Result);
		springLayout.putConstraint(SpringLayout.WEST, lblSuccessfullyConvertedTo, 10, SpringLayout.WEST, this.panel_Result);
		...
		springLayout.putConstraint(SpringLayout.NORTH, this.lbl_OutputName, 6, SpringLayout.SOUTH, lblSuccessfullyConvertedTo);
		springLayout.putConstraint(SpringLayout.WEST, this.lbl_OutputName, 0, SpringLayout.WEST, lblSuccessfullyConvertedTo);
		...
		springLayout.putConstraint(SpringLayout.EAST, this.lbl_Texturesfound, -10, SpringLayout.EAST, this.panel_Result);
		...
		springLayout.putConstraint(SpringLayout.WEST, this.lbl_Texturesfound, 0, SpringLayout.WEST, lblSuccessfullyConvertedTo);
		this.panel_Result.add(this.lbl_Texturesfound);

		this.panel_OpenHammerEditor = new JPanel();
		springLayout.putConstraint(SpringLayout.NORTH, this.panel_OpenHammerEditor, 6, SpringLayout.SOUTH, this.lbl_OutputName);
		springLayout.putConstraint(SpringLayout.WEST, this.panel_OpenHammerEditor, 10, SpringLayout.WEST, this.panel_Result);
		springLayout.putConstraint(SpringLayout.EAST, this.panel_OpenHammerEditor, 0, SpringLayout.EAST, lblSuccessfullyConvertedTo);
		this.panel_Result.add(this.panel_OpenHammerEditor);

		this.lbl_Description1 = new JLabel("(for )");
		springLayout.putConstraint(SpringLayout.NORTH, this.lbl_Description1, 0, SpringLayout.SOUTH, this.panel_OpenHammerEditor);
		springLayout.putConstraint(SpringLayout.WEST, this.lbl_Description1, 0, SpringLayout.WEST, lblSuccessfullyConvertedTo);
		springLayout.putConstraint(SpringLayout.EAST, this.lbl_Description1, 0, SpringLayout.EAST, lblSuccessfullyConvertedTo);
		...
		springLayout.putConstraint(SpringLayout.NORTH, btn_OpenHammerEditor, 32, SpringLayout.SOUTH, this.lbl_Texturesfound);
		springLayout.putConstraint(SpringLayout.EAST, btn_OpenHammerEditor, 0, SpringLayout.EAST, lblSuccessfullyConvertedTo);
		...
		springLayout.putConstraint(SpringLayout.NORTH, lblNextSteps, 24, SpringLayout.SOUTH, this.panel_OpenHammerEditor);
		...
		springLayout.putConstraint(SpringLayout.WEST, this.lbl_FileOpen, 0, SpringLayout.WEST, lblSuccessfullyConvertedTo);
		...
		springLayout.putConstraint(SpringLayout.WEST, lblConvertToBSP, 0, SpringLayout.WEST, lblSuccessfullyConvertedTo);
