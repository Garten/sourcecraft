...
public class DetailsPanel extends JPanel {
	...
	private RunnableWith<String> uponSelectTexturePack = place -> RunnableEmpty.doNothing();
	private RunnableWith<String> uponSelectTexturePackIntern = texturePack -> this.uponSelectTexturePack.run(texturePack);

	private Runnable run = RunnableEmpty.INSTANCE;
...
//		this.lbl_TexturesUpToDate.setVisible(visible);
	...
	private void initialize() {
		...
		sl_panel_Details.putConstraint(SpringLayout.WEST, this.comboBox_ConverterOptions, 10, SpringLayout.WEST, panel_Details);
		sl_panel_Details.putConstraint(SpringLayout.EAST, this.comboBox_ConverterOptions, -10, SpringLayout.EAST, panel_Details);
		...
		sl_panel_Details.putConstraint(SpringLayout.NORTH, this.comboBox_ConverterOptions, 6, SpringLayout.SOUTH, lbl_Details);
		...
		sl_panel_Details.putConstraint(SpringLayout.NORTH, lbl_Details_Textures, 25, SpringLayout.SOUTH, this.comboBox_ConverterOptions);
		sl_panel_Details.putConstraint(SpringLayout.WEST, lbl_Details_Textures, 0, SpringLayout.WEST, this.comboBox_ConverterOptions);
		lbl_Details_Textures.setFont(Gui.DEFAULT_FONT);
		panel_Details.add(lbl_Details_Textures);

		this.comboBox_Textures = new JComboBox<>();
		sl_panel_Details.putConstraint(SpringLayout.NORTH, this.comboBox_Textures, 6, SpringLayout.SOUTH, lbl_Details_Textures);
		sl_panel_Details.putConstraint(SpringLayout.WEST, this.comboBox_Textures, 0, SpringLayout.WEST, this.comboBox_ConverterOptions);
		sl_panel_Details.putConstraint(SpringLayout.EAST, this.comboBox_Textures, -10, SpringLayout.EAST, panel_Details);
		...
		sl_panel_Details.putConstraint(SpringLayout.NORTH, this.chckbx_CopyTextures, 6, SpringLayout.SOUTH, this.comboBox_Textures);
		...
		sl_panel_Details.putConstraint(SpringLayout.NORTH, this.lbl_TexturesUpToDate, 6, SpringLayout.SOUTH, this.chckbx_CopyTextures);
		sl_panel_Details.putConstraint(SpringLayout.WEST, this.lbl_TexturesUpToDate, 0, SpringLayout.WEST, this.comboBox_ConverterOptions);
